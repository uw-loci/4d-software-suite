//************************************************************
//*		C L A S S  C I R C L E  O B J E C T  P R O X Y
//************************************************************

class CircleObjectProxy extends AnnotationObjectProxy
{
	protected	int			pen_width = 0;
	protected	boolean		filled = false;

	public CircleObjectProxy(CircleObject obj)
	{
		super(obj);
