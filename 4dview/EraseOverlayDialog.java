...
public class EraseOverlayDialog extends Dialog
{
	...
	//***************************************************************************
	//*		I N I T
	//*		Added 4/4/03 for v1.72
	//***************************************************************************
	public EraseOverlayDialog(BooleanWrapper confirm, Frame parent, boolean modal)
	{
		super(parent, modal);
		...
		label_one = new java.awt.Label("Erase this overlay?",Label.CENTER);
		constraints.gridx = 0;
		constraints.gridy = 0;
...
}// end of class EraseOverlayDialog
