	...
	void readOverlayFromStream(ByteArrayInputStream is) throws Exception
	{
		...
		try
		{
			...
			for (i = 0; i <  num_obj.intValue(); i++)
			{
				...
				//if (ao != null)
					//addObject(ao);
        if (aop instanceof TextObjectProxy) System.out.println("[Text]");
        else if (aop instanceof ArrowObjectProxy) {
          System.out.println("[Arrow]");
        }
        else if (aop instanceof OutlineObjectProxy) {
          System.out.println("[Outline]");
        }
        else {
          System.err.println("Unimplemented aop handler: " +
            aop.getClass().getName());
        }

        System.out.println("structure_descriptor=" + aop.structure_descriptor);
        System.out.println("object_comments=" + aop.object_comments);
        System.out.println("object_rect_x=" + aop.object_rect_x);
        System.out.println("object_rect_y=" + aop.object_rect_y);
        System.out.println("object_rect_width=" + aop.object_rect_width);
        System.out.println("object_rect_height=" + aop.object_rect_height);
        System.out.println("object_type=" + aop.object_type);
        System.out.println("object_color=" + aop.object_color);

        if (aop instanceof TextObjectProxy) {
          TextObjectProxy text = (TextObjectProxy) aop;
          System.out.println("text_string=" + text.text_string);
          System.out.println("text_counter=" + text.text_counter);
          System.out.println("start_pt_x=" + text.start_pt_x);
          System.out.println("start_pt_y=" + text.start_pt_y);
          System.out.println("pen_pt_x=" + text.pen_pt_x);
          System.out.println("pen_pt_y=" + text.pen_pt_y);
          System.out.println("font_name=" + text.font_name);
          System.out.println("font_style=" + text.font_style);
          System.out.println("font_size=" + text.font_size);
          System.out.println("bottom_margin=" + text.bottom_margin);
        }
        else if (aop instanceof ArrowObjectProxy) {
          ArrowObjectProxy arrow = (ArrowObjectProxy) aop;
          System.out.println("start_pt_x=" + arrow.start_pt_x);
          System.out.println("start_pt_y=" + arrow.start_pt_y);
          System.out.println("end_pt_x=" + arrow.end_pt_x);
          System.out.println("end_pt_y=" + arrow.end_pt_y);
          System.out.println("filled=" + arrow.filled);
        }
        else if (aop instanceof OutlineObjectProxy) {
          OutlineObjectProxy outline = (OutlineObjectProxy) aop;
          System.out.println("pen_width=" + outline.pen_width);
          System.out.println("num_points=" + outline.num_points);
          int size = outline.point_array.size();
          System.out.println("point_array_size=" + size);
          for (int pt=0; pt<size; pt++) {
            Point p = (Point) outline.point_array.elementAt(pt);
            System.out.println("point" + pt + "=(" + p.x + "," + p.y + ")");
          }
        }
			}// for each object
		}
